     ...
     >      TWOPI_D=6.283185307179586476925286766559005768394_dp
      ...
      END TYPE sprs2_dp
      ! dummy numbers
      real(sp), parameter :: zero = 0d0
      real(sp), parameter :: tenth = 0.1d0
      real(sp), parameter :: quart = 0.25d0
      real(sp), parameter :: half = 0.5d0
      real(sp), parameter :: one = 1d0
      real(sp), parameter :: two = 2d0
      real(sp), parameter :: three = 3d0
      real(sp), parameter :: four = 4d0
      real(sp), parameter :: ten = 10d0
      real(sp), parameter :: root2 = sqrt(two)
      real(sp), parameter :: root3 = sqrt(three)
      real(sp), parameter :: PI2 = PI*PI
      real(sp), parameter :: PI3 = PI*PI*PI
      real(sp), parameter :: twoPI2 = twoPI*twoPI
      END MODULE nrtype
